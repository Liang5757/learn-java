...
<!--kindeditor-->
<script type="${base}/resources/js/plugins/editor/kindeditor.js"></script>
...
<!--表单提交-->
<script src="${base}/resources/plugins/jquery.form.js" type="text/javascript"></script>
<!-- Loippi Javascript -->
...
<!-- datetimepicker 日期插件-->
<script src="${base}/resources/js/datetimepicker/bootstrap-datetimepicker.js"></script>
<script src="${base}/resources/js/datetimepicker/bootstrap-datetimepicker.zh-CN.js"></script>

<!-- select2 -->
<script src="${base}/resources/js/select2.min.js"></script>

<!-- 圆形进度条-->
<script src="${base}/resources/js/circles/circles.min.js"></script>