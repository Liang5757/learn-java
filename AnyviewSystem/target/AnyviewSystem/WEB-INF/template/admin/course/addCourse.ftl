        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
              ...
              <div class="ibox-content">
                    <form id="saveCourseForm" class="form-horizontal" action="${base}/admin/course/saveAddCourse.jhtml" method="post">
                       <input type="hidden" name="courseUpdater" value="${systemUser.name}">
                       <input type="hidden" name="courseCreater" value="${systemUser.name}">
                                    ...
                                    <div class="col-sm-9">
                                      ...
                                      <input name="schoolId" id="schoolId" class="hidden"> -->
                                       ...
                                       <select class="form-control" name="schoolId" id="schoolName" onchange="add1(this.value);">
		                            	...
		                            	[/#if]
		                            	[#if systemUser.roleId=1]
		                            		<input type="hidden" id="schoolId" value="${systemUser.school.id}" name="schoolId">${systemUser.school.schoolName}
		                            	[/#if]
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                          <div class="row">
                            <div class="col-sm-6 vaild">
                                ...
                                <div class="col-sm-9">
                                    <input name="courseName" id="courseName" placeholder="请输入课程名称" class="form-control">
                                </div>
                            </div>
                          </div>
                        </div>
