        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form id="saveQuestionbankForm" class="form-horizontal" action="editSave.jhtml" method="post">
                        <div class="form-group" >
                        	<div class="row" >
                                <div class="col-sm-6" style="display:none">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="id" id="questionBankId" class="form-control" maxlength="200"
                                               value="${questionbank.id}" readonly="readonly"/>
                                    </div>
                                </div>
                            </div>
                            &nbsp;
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="course_name" id="course_name"
                                          ...
                                          <option value="" [#if questionbank.course_name==""]selected[/#if]>请选择课程</option>
		 								  [#list courseList as course]
	                                           <option value="${course.courseName}" [#if questionbank.course_name==course.courseName]selected[/#if]>${course.courseName}</option>
	                                      [/#list]
                                ...
                                <div class="col-sm-6 vaild">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="question_bank" placeholder="请输入题库名称"  id="question_bank" class="form-control"
                                               maxlength="200" value="${questionbank.question_bank}"/>
                                    </div>
                                </div>
                            </div>
                            &nbsp;
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="public_level" id="public_level"
                                                class="bs-select form-control">
                                        <option value="" [#if questionbank.public_level==""]selected[/#if]>请选择公开级别</option>
                                        <option value="0"  [#if questionbank.public_level=="0" ]selected[/#if]>完全保密</option>
                                        [#if systemUser.roleId==-1]
                                         <option value="1"  [#if questionbank.public_level=="1" ]selected[/#if]>公开给特定学校</option>
                                        [/#if]
                                        [#if systemUser.roleId==1 || systemUser.roleId==0]
                                        <option value="3"  [#if questionbank.public_level=="3"]selected[/#if]>本校公开</option>
                                        [/#if]
                                        <option value="2"  [#if questionbank.public_level=="2" ]selected[/#if]>完全公开</option>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-9" id="selectSchoolName">
                                        ...
                                        <div style="display:inline-block" id="schools">
                                          <input type="hidden" name="specific_school" id="specific_school" value="${questionbank.specific_school}"/>
                                          <span id="main_school">
