...
!function (a, b) {
    function f(a, b, c) {
        b = b || document, c = c || "*";
        for (var d = 0, e = 0, f = [], g = b.getElementsByTagName(c), h = g.length, i = new RegExp("(^|\\s)" + a + "(\\s|$)"); h > d; d++) i.test(g[d].className) && (f[e] = g[d], e++);
        return f
    }

    function g(d) {
        var e = c.expando, f = d === a ? 0 : d[e];
    ...
    return a.$ === b && (a.$ = c), c.fn = c.prototype = {
        constructor: function (a, b) {
            ...
            var a = this[0], b = a.getBoundingClientRect(), c = a.ownerDocument, d = c.body, e = c.documentElement,
                f = e.clientTop || d.clientTop || 0, g = e.clientLeft || d.clientLeft || 0,
                h = b.top + (self.pageYOffset || e.scrollTop) - f, i = b.left + (self.pageXOffset || e.scrollLeft) - g;
            return {left: i, top: h}
        }, html: function (a) {
            var d = this[0];
        ...
        var d = !0, e = c.expando, f = c.cache, h = g(a), i = h && f[h];
        if (i) if (b) {
            delete i[b];
            for (var j in i) d = !1;
            d && delete c.cache[h]
        } else delete f[h], a.removeAttribute ? a.removeAttribute(e) : a[e] = null
    }, c.uuid = 0, c.cache = {}, c.expando = "@cache" + +new Date, c.event = {
        add: function (a, b, d) {
            var e, f, g = c.event, h = c.data(a, "@events") || c.data(a, "@events", {});
            ...
            var e, f, g, h = c.event, i = !0, j = c.data(a, "@events");
            if (j) if (b) {
                if (f = j[b]) {
                    if (g = f.listeners, d) for (e = 0; e < g.length; e++) g[e] === d && g.splice(e--, 1); else f.listeners = [];
            ...
            return function (d) {
                ...
                for (var g, e = 0, f = b.listeners; g = f[e++];) g.call(b.elem, d) === !1 && (d.preventDefault(), d.stopPropagation())
            }
        }, fix: function (a) {
            if (a.target) return a;
            var b = {
                target: a.srcElement || document, preventDefault: function () {
                    a.returnValue = !1
        ...
        for (var d, b = 0, e = a.length, f = c.event.remove, g = c.removeData; e > b; b++) d = a[b], f(d), g(d)
    ...
    var d, e = 0, g = (a(document.getElementsByTagName("html")[0]), "artDialog" + +new Date),
        ...
        }, l = k(), m = function (a, b, f) {
            a = a || {}, ("string" == typeof a || 1 === a.nodeType) && (a = {content: a, fixed: !i});
            var h, k = m.defaults, l = a.follow = 1 === this.nodeType && this || a.follow;
    ...
    m.version = "5.0.4", m.fn = m.prototype = {
        _create: function (a) {
            ...
            var c, d, e, f, g = this, h = this.dom.content, i = h[0];
            ...
            var b = this.dom, c = b.outer, d = b.title, e = "d-state-noTitle";
            return a === !1 ? (d.hide().html(""), c.addClass(e)) : (d.show().html(a), c.removeClass(e)), this
        }, position: function () {
            var a = this.dom, b = a.wrap[0], c = a.window, d = a.document, e = this.config.fixed,
                f = e ? 0 : d.scrollLeft(), h = e ? 0 : d.scrollTop(), i = c.width(), j = c.height(), k = b.offsetWidth,
                l = b.offsetHeight, m = (i - k) / 2 + f, n = 382 * (j - l) / 1e3 + h, o = b.style;
            ...
            return "number" == typeof a && (a += "px"), "number" == typeof b && (b += "px"), c.width = a, c.height = b, this
        }, follow: function (b) {
            var c = a(b), d = this.config;
            if (!b || !b.offsetWidth && !b.offsetHeight) return this.position(this._left, this._top);
            var e = d.fixed, f = g + "follow", h = this.dom, i = h.window, j = h.document, k = i.width(),
                l = i.height(), m = j.scrollLeft(), n = j.scrollTop(), o = c.offset(), p = b.offsetWidth,
                q = b.offsetHeight, r = e ? o.left - m : o.left, s = e ? o.top - n : o.top, t = this.dom.wrap[0],
                u = t.style, v = t.offsetWidth, w = t.offsetHeight, x = r - (v - p) / 2, y = s + q, z = e ? 0 : m,
                A = e ? 0 : n;
            ...
            var a = this.dom, b = a.wrap, c = m.list, e = this.config.beforeunload;
            if (e && e.call(this) === !1) return this;
            if (m.focus === this && (m.focus = null), this._follow && this._follow.removeAttribute(g + "follow"), this._elemBack && this._elemBack(), this.time(), this.unlock(), this._removeEvent(), delete c[this.config.id], d) b.remove(); else {
            ...
            var a = this.dom, b = m.focus, c = m.defaults.zIndex++;
            ...
            var c = this, e = (this.config, this.dom), f = document.createElement("div"), g = a(f),
            ...
            for (var f, g = 0, h = {}, i = e.getElementsByTagName("*"), j = i.length; j > g; g++) f = i[g].className.split("d-")[1], f && (h[f] = a(i[g]));
        ...
        var b = a.target, c = b.nodeName, d = /^input|textarea$/i, e = m.focus, f = a.keyCode;
    ...
    }), m._templates = '<div class="d-outer" role="dialog" tabindex="-1" aria-labelledby="d-title-{id}" aria-describedby="d-content-{id}"><table class="d-border"><tbody><tr><td class="d-nw"></td><td class="d-n"></td><td class="d-ne"></td></tr><tr><td class="d-w"></td><td class="d-c"><div class="d-inner"><table class="d-dialog"><tbody><tr><td class="d-header"><div class="d-titleBar"><div id="d-title-{id}" class="d-title"></div><a class="d-close" href="javascript:;" title="{cancelValue}">\xd7</a></div></td></tr><tr><td class="d-main"><div id="d-content-{id}" class="d-content"></div></td></tr><tr><td class="d-footer"><div class="d-buttons"></div></td></tr></tbody></table></div></td><td class="d-e"></td></tr><tr><td class="d-sw"></td><td class="d-s"></td><td class="d-se"></td></tr></tbody></table></div>', m.defaults = {
