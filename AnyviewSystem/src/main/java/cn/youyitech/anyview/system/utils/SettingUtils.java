...
import cn.youyitech.anyview.system.support.CommonAttributes;
import cn.youyitech.anyview.system.support.EnumConverter;
...
public final class SettingUtils {
	...
	public static void set(Setting setting) {
		try {
			File frameworkXmlFile = new ClassPathResource(CommonAttributes.FRAMEWORK_XML_PATH).getFile();
