/*
 * Copyright 2005-2013 framework.net. All rights reserved.
 * Support: http://www.framework.net
 * License: http://www.framework.net/license
 * 
 * JavaScript - lSelect
 * Version: 3.0
 */
	...
	$.fn.extend({
		lSelect: function(options) {
			...
			return this.each(function() {
				...
				selectName = selectName.replace(/[\.\+=!-\?]/g, "_" ); //去掉特殊符号
				...
				function addSelect($position, parentId, currentId) {
					...
					var select = '<select class="form-control" style="    vertical-align: middle;display: inline-block;width: 145px !important;" name="' + selectName + '">';
