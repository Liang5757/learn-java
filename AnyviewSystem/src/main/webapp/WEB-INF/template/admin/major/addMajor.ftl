        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form id="saveMajorForm" class="form-horizontal" action="${base}/admin/major/saveAddMajor.jhtml" method="post">
                        <div class="form-group">
                            <div class="row">
							<input type="hidden" name="id" id="majorId" value="" >
                               <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-9">
                                      ...
                                      <input name="schoolId" id="schoolId" class="hidden"> -->
                                        <!-- <select  id="schoolId" onchange="add1(this.value);" data-placeholder="请选择学校"
                        ...
                        <div class="form-group">
                          <div class="row">
                            <div class="col-sm-6 vaild">
                                  ...
                                  <div class="col-sm-9">
                                      <input name="majorName" id="majorName" placeholder="请输入专业名称" class="form-control">
                                    <input type="hidden" name="majorCreater" value="${systemUser.name}">
                                    <input type="hidden" name="majorUpdater" value="${systemUser.name}">
                                 	 <input type="hidden" class="form-control" name="id" id="majorId" value="">
                                  </div>
                            </div>
                          </div>
                        </div>
