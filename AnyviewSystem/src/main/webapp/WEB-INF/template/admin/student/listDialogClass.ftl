                ...
                <form id="commonForm" action="${base}/admin/course_arrange/listDialogClass.jhtml"  method="get">
					...
					<div class="row">
                            <div class="col-sm-3 m-b-xs">
                                <input type="text" placeholder="请输入班级名称" name="className" id="className" class="input-sm form-control">
                            </div>
                     		<div class="col-sm-1">
                                <div class="input-group">
                                    <input id="check" type="button" class="btn btn-sm btn-danger" value="查询"/>
                                </div>
                            </div>
                    </div>
                        <div class="dataTables_wrapper form-inline dialog-table">
                            <table class="table table-striped table-bordered table-hover dataTables-example dataTable dialog-table">
                                ...
                                <tr>
                                    <td>
                                        <input type="checkbox" class="i-checks" name="ids" value="${student_class.id}" id="${student_class.id}" data-name="${student_class.className}">
                                    </td>
                                    	 <td>${student_class_index + 1}</td>
                                    	 <td>${student_class.className}</td>
                                    	 <td class="class_year">${student_class.year}</td>
                                </tr>
                                [/#list]
                                </tbody>
                            </table>
...
<script>
    ...
    var listTemplate = "${base}/admin/student/listDialogClass.jhtml";
    ...
    function reload() {
        ...
        $.get(listTemplate, data, function (result, status) {
           ...
           /* // 复选框
            $('#selectClassList .i-checks').iCheck({checkboxClass: 'icheckbox_square-red', radioClass: 'iradio_square-red',});
            // 选择所有，复选框改变
