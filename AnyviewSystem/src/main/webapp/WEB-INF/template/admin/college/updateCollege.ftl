        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form  class="form-horizontal" id="saveCollegeForm" action="editSave.jhtml" method="post">
                       	 <input type="hidden" name="collegeUpdater" value="${systemUser.name}">
                       	<input type="hidden" id="collegeId" name="id" value="${college.id}">
                            ...
                            <div class="row">
                               <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-9">
                                     ...
                                     <!-- <input name="schoolName" id="schoolName" placeholder="请输入学校名称" class="form-control" value="${college.school.schoolName}">
                                     <input name="schoolId" id="schoolId" class="hidden" value="${college.school.id}"> -->
                                        <!-- <select name="schoolId" id="schoolId" data-placeholder="请选择学校"
                                                class="bs-select form-control">
                                            <option hassubinfo="true" value="${college.school.id}">${college.school.schoolName}</option>
	                                        [#list schoolLists as school]
	                                            <option value="${school.id}">${school.schoolName}</option>
	                                        [/#list]
	                                     </select> -->
                                       <select class="form-control" name="schoolId" id="schoolName" value="${college.school.id}">
                                          <option hassubinfo="true" value="${college.school.id}">${college.school.schoolName}</option>
                                       </select>
	                                  [/#if]
	                                  [#if systemUser.roleId=1]
