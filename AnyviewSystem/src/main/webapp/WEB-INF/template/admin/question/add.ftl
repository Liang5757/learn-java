            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-title">
                    <div class="ibox-tools">
                        <button class="btn btn-white" onclick="window.history.back()" style="margin-top: -8px;">返回</button>
                    </div>

                    <h5>添加题目</h5>
                </div>
                <div class="ibox-content">
                    <form id="saveQuestionForm" class="form-horizontal" action="save.jhtml" method="post">
                        <div class="form-group" >
                        	...
                        	<div class="row" >
                                <div class="col-sm-6" style="display:none">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="questionId" id="questionId" class="form-control" maxlength="200"
                                                readonly="readonly"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 vaild">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="question_name" placeholder="请输入题目名称"  id="question_name" class="form-control"
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-9">
                                        <a class="btn btn-sm btn-primary" href="javascript:;" onclick="sumb(-1,0)">编辑</a>
                                        <a class="btn btn-sm btn-primary" href="javascript:;" onclick="sumb()">导入</a>
<!--                                         <input id="checkContentFlag" class="hidden" name="checkContentFlag"> -->
                                    </div>
                                </div>
                            </div>
                            &nbsp;
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <option value="1" [#if question.public_level == 1]selected[/#if]>公开给特定学校</option>
                                        [/#if]
                                        [#if systemUser.roleId=1 || systemUser.roleId=0]
                                        <option value="3" [#if question.public_level == 3]selected[/#if]>本校公开</option>
                                        [/#if]
                            ...
                            &nbsp;
                            [#if question.public_level == 1 || question.public_level == -1]
                              <div class="row" id="specific" [#if question.public_level == -1]style="display:none;"[/#if]>
                                  <div class="col-sm-6">
                                      ...
                                      <div class="col-sm-9" id="selectSchoolName">
                                        ...
                                        <!-- 添加学校名称及ID处 -->
                                        [#if question.public_level == 1]
                                          <div style="display:inline-block" id="schools">
                                            <input type="hidden" name="specific_school" id="specific_school"/>
                                            <span id="main_school">${question.specific_school}</span>
                                          </div>
                                        [/#if]
                                      </div>
                                  </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="remark" id="remark" placeholder="请输入题目备注"  class="form-control"
...
<script>
    ...
    $(document).ready(function () {
      ...
      $(".ok-set-school").click(function () {
            ...
            submitHandler:function (form) {   //不使用submit默认提交功能，先进行自定义验证，成功则提交表单
                $.ajax({
                  ...
                  data: {
                    id: $("#questionId").val(),
                    chapter: $("#chapter").val(),
                    questionName: $("#question_name").val()
                  },
        ...
        //获取存储在session中的临时数据,并将其放入form中
        // var inpFlag = storage.getItem("checkContentFlag")
        // if(inpFlag!=null){
        //   $("#checkContentFlag").val(inpFlag)
        // }
   ...
   function sumb(id,flag){
    ...
    //     // console.log(storage.getItem("checkContentFlag"));
    // }
</script>
</body>
</html>
