...
public class ObjectFactory {
    ...
    private final static QName _MinusResponse_QNAME = new QName("http://Service/", "minusResponse");
    private final static QName _Login_QNAME = new QName("http://Service/", "login");
    private final static QName _Minus_QNAME = new QName("http://Service/", "minus");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service/", name = "minusResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service/", name = "minus")
